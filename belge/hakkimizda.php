...
<head>
    ...
    <title><?php echo  $site_adi." - Künye";?></title>
</head>
<body>
...
<div style="margin-bottom:11px;"></div>
        ...
        <!-- CUBUK -->
<div class="katCubuk"><span></span><h4>Hakkımızda</h4></div>
        <!-- CUBUK SON -->
...
<div class="medium-container vertical-center">
	<div class="anaIcerik">
    <!-- görsel -->
    <img id="baslikGorsel" src="../img/hakkimizda.jpg" alt="<?php echo $site_adi.' hakkımızda'; ?>">
    <!-- ilk span -->
    <!-- içerik -->
    ...
    <br>
    <!-- etiketler -->
    <span class="Bilgi" style="display:block;">&nbsp;<i class="fas fa-tag"></i>&nbsp;<?php echo $site_adi;?>, hakkında, hakkımızda, künye, biz kimiz, tanıtım</span>
