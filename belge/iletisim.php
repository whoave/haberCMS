...
<head>
    ...
    <title><?php echo  $site_adi." - İletişim";?></title>
</head>
<body>
...
<div style="margin-bottom:11px;"></div>
        ...
        <!-- CUBUK -->
<div class="katCubuk"><span></span><h4>İletişim</h4></div>
        <!-- CUBUK SON -->
...
<div class="medium-container vertical-center">
	<div class="anaIcerik">
    <!-- görsel -->
    <img id="baslikGorsel" src="../img/iletisim.jpg" alt="<?php echo $site_adi.' iletişim'; ?>">
    <!-- ilk span -->
    <!-- içerik -->
    ...
    <br>
    <!-- etiketler -->
    <span class="Bilgi" style="display:block;">&nbsp;<i class="fas fa-tag"></i>&nbsp;<?php echo $site_adi;?>, iletişim, ulaşım, bilgiler, telefon, adres</span>
