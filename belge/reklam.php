...
<head>
    ...
    <title><?php echo  $site_adi." - Reklam";?></title>
</head>
<body>
...
<div style="margin-bottom:11px;"></div>
        ...
        <!-- CUBUK -->
<div class="katCubuk"><span></span><h4>Reklam</h4></div>
        <!-- CUBUK SON -->
...
<div class="medium-container vertical-center">
	<div class="anaIcerik">
    <!-- görsel -->
    <img id="baslikGorsel" src="../img/reklamlar.jpg" alt="<?php echo $site_adi.' reklam'; ?>">
    <!-- ilk span -->
    <!-- içerik -->
    ...
    <br>
    <!-- etiketler -->
    <span class="Bilgi" style="display:block;">&nbsp;<i class="fas fa-tag"></i>&nbsp;<?php echo $site_adi;?>, reklam, reklam anlaşması, reklam ver, reklam vermek istiyorum</span>
