...
<head>
    ...
    <title><?php echo  $site_adi." - Kullanım Sözleşmesi";?></title>
</head>
<body>
...
<div style="margin-bottom:11px;"></div>
        ...
        <!-- CUBUK -->
<div class="katCubuk"><span></span><h4>Kullanım Sözleşmesi</h4></div>
        <!-- CUBUK SON -->
...
<div class="medium-container vertical-center">
	<div class="anaIcerik">
    <!-- görsel -->
    <img id="baslikGorsel" src="../img/sozlesme.jpg" alt="<?php echo $site_adi.' sözleşme'; ?>">
    <!-- ilk span -->
    <!-- içerik -->
    ...
    <br>
    <!-- etiketler -->
    <span class="Bilgi" style="display:block;">&nbsp;<i class="fas fa-tag"></i>&nbsp;<?php echo $site_adi;?>, sözleşme, site sözleşmesi, kullanıcı sözleşmesi, kullanım sözleşmesi</span>
